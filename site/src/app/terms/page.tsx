  ...
  return (
    <div className="mx-auto w-full max-w-2xl px-4 pt-8 sm:px-6 sm:pt-12">
      ...
      <div className="panel panel-lit mt-4 space-y-6 p-7 text-[0.92rem] leading-relaxed text-t2">
        ...
        <section>
          <h2 className="font-semibold">4. Membership subscriptions</h2>
          <p className="mt-2">
            Membership costs ${SITE.priceMonthly} per month, billed automatically until cancelled. You can
            ...
            See our Cancellation Policy for how cancellation works.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-2">
            ...
            will notify members in advance and stop all billing.
          </p>
        </section>
