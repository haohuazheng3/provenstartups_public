...
export const metadata = { title: "Welcome to the Unicorn Club", robots: { index: false } };
    ...
    <div className="mx-auto flex w-full max-w-xl flex-col items-center px-4 pt-10 sm:pt-16 text-center">
      {ok ? (
        <div className="panel panel-lit flex w-full flex-col items-center gap-4 p-10">
          ...
          <h1 className="text-2xl font-semibold">You&apos;re in the Unicorn Club</h1>
          <p className="text-sm text-t3">
            Every breakdown, the founder playbooks, the filters, and your 10 build specs a week are
            unlocked.
          </p>
